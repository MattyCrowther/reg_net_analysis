...
class TranscriptionUnitRoleEquivalent(PhysicalEquivalent):
    def __init__(self):
        restrictions = [pr.TranscriptionUnitRoleRestriction()]
        super().__init__(restrictions)

class OperonRoleEquivalent(PhysicalEquivalent):
    def __init__(self):
        restrictions = [pr.OperonRoleRestriction()]
        super().__init__(restrictions)
...
class RNARoleEquivalent(PhysicalEquivalent):
    def __init__(self):
        restrictions = [pr.RNARoleRestriction()]
        super().__init__(restrictions)
