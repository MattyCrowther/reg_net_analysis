...
class DNARoleRestriction(RoleRestriction):
    def __init__(self):
        values = identifiers.roles.DNA + identifiers.roles.DNARegion
...
class TranscriptionUnitRoleRestriction(RoleRestriction):
    def __init__(self):
        super().__init__(identifiers.roles.transcriptionUnit)  

class OperonRoleRestriction(RoleRestriction):
    def __init__(self):
        super().__init__(identifiers.roles.operon)  
